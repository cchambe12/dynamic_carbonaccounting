...
write.csv(addit_oaks, "output/northwoods_oaks_scenarios_v2.csv", row.names=FALSE)
write.csv(project.bau, "output/northwoods_oaks_projectvbau_fia_v2.csv", row.names = FALSE)
...
write.csv(addit_mbbs, "output/northwoods_mbbs_scenarios_v2.csv", row.names=FALSE)
write.csv(project.bau, "output/northwoods_mbbs_projectvbau_fia_v2.csv", row.names = FALSE)
