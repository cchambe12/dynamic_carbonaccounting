...
For initial exploration of the data, we will first get FIA plots from **MI, MN, and WI**. We are downloading data directly from DataMart for most up to date information. Please modify the above states as necessary. We are then subsetting to ecosections **222**. Again, please modify as necessary.  
...
states <- c("MI", "MN", "WI") #**ENTER STATE ABBREVIATIONS HERE**
fullstatelist <- c("Michigan", "Minnesota", "Wisconsin") #**ENTER STATE NAMES HERE**
region <- "northwoods"  #**ENTER REGION FOLDER NAME HERE**

if(use.ecosections==TRUE){
ecosubstokeep <- c("222")  #**ENTER ECOSECTIONS HERE**
}
