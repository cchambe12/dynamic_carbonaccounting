...
For initial exploration of the data, we will first get FIA plots from **MD, OH, PA, WV**. We are downloading data directly from DataMart for most up to date information. Please modify the above states as necessary. We are then subsetting to ecosections **211, 221, 222, 223, 232, M221**. Again, please modify as necessary.  
...
ecosubstokeep <- c("211", "221", "222", "223", "232", "M221")  #**ENTER ECOSECTIONS HERE**
}
...
datclean <- full_join(datmbb, datoak)
