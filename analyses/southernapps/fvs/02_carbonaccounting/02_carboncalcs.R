...
mbb <- read.csv("../../output/clean_southernapps_fiadata.csv") %>%
...
oh <- read.csv("../../output/clean_southernapps_fiadata.csv") %>%
...
remv2oh = mean(oh$baac.perc.cut.prev.prev[oh$baac.perc.cut.prev>0])
