...
For initial exploration of the data, we will first get FIA plots from **AL, GA, KY, NC, SC, TN, and VA**. We are downloading data directly from DataMart for most up to date information. Please modify the above states as necessary. We are then subsetting to ecosections **221, 223, 231, M221**. Again, please modify as necessary.  
...
states <- c("AL", "GA", "KY", "NC", "SC", "TN", "VA") #**ENTER STATE ABBREVIATIONS HERE**
fullstatelist <- c("Alabama", "Georgia", "Kentucky", "North Carolina", 
                   "South Carolina", "Tennessee", "Virginia") #**ENTER STATE NAMES HERE**
region <- "southernapps"  #**ENTER REGION FOLDER NAME HERE**

if(use.ecosections==TRUE){
ecosubstokeep <- c("221", "223", "231", "M221")  #**ENTER ECOSECTIONS HERE**
}
